...
namespace Akademiks2._0 {
    ...
    public partial class StudentDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudentRow AddStudentRow(string First_Name, string Last_Name, System.DateTime Date_Of_Birth, string Phone, string Address, string Gender) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudentRow FindByFirst_Name(string First_Name) {
...
namespace Akademiks2._0.StudentDataSetTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Student] WHERE (([First Name] = @Original_First_Name) AND ([Last Name] = @Original_Last_Name) AND ([Date Of Birth] = @Original_Date_Of_Birth) AND ([Phone] = @Original_Phone) AND ([Address] = @Original_Address) AND ([Gender] = @Original_Gender))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Student] ([First Name], [Last Name], [Date Of Birth], [Phone], [Address], [Gender]) VALUES (@First_Name, @Last_Name, @Date_Of_Birth, @Phone, @Address, @Gender);
SELECT [First Name], [Last Name], [Date Of Birth], Phone, Address, Gender FROM Student WHERE ([First Name] = @First_Name)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [First Name] = @First_Name, [Last Name] = @Last_Name, [Date Of Birth] = @Date_Of_Birth, [Phone] = @Phone, [Address] = @Address, [Gender] = @Gender WHERE (([First Name] = @Original_First_Name) AND ([Last Name] = @Original_Last_Name) AND ([Date Of Birth] = @Original_Date_Of_Birth) AND ([Phone] = @Original_Phone) AND ([Address] = @Original_Address) AND ([Gender] = @Original_Gender));
SELECT [First Name], [Last Name], [Date Of Birth], Phone, Address, Gender FROM Student WHERE ([First Name] = @First_Name)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Akademiks2._0.Properties.Settings.Default.StudentDatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT [First Name], [Last Name], [Date Of Birth], Phone, Address, Gender FROM db" +
                "o.Student";
        ...
        public virtual int Delete(string Original_First_Name, string Original_Last_Name, System.DateTime Original_Date_Of_Birth, string Original_Phone, string Original_Address, string Original_Gender) {
        ...
        public virtual int Insert(string First_Name, string Last_Name, System.DateTime Date_Of_Birth, string Phone, string Address, string Gender) {
            if ((First_Name == null)) {
        ...
        public virtual int Update(string First_Name, string Last_Name, System.DateTime Date_Of_Birth, string Phone, string Address, string Gender, string Original_First_Name, string Original_Last_Name, System.DateTime Original_Date_Of_Birth, string Original_Phone, string Original_Address, string Original_Gender) {
            if ((First_Name == null)) {
                throw new global::System.ArgumentNullException("First_Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Last_Name, System.DateTime Date_Of_Birth, string Phone, string Address, string Gender, string Original_First_Name, string Original_Last_Name, System.DateTime Original_Date_Of_Birth, string Original_Phone, string Original_Address, string Original_Gender) {
            return this.Update(Original_First_Name, Last_Name, Date_Of_Birth, Phone, Address, Gender, Original_First_Name, Original_Last_Name, Original_Date_Of_Birth, Original_Phone, Original_Address, Original_Gender);
        }
    }
